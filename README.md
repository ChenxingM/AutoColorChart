...
![2.4主窗口](https://github.com/ChenxingM/AutoColorChart/blob/main/screenshoots/2.4main.PNG "Auto Color Chart 2.4.0 メインウィンド")
...
### AEスクリプトはすでに新JSON、XMLと従来のJSON、XML両方に対応済みです。
